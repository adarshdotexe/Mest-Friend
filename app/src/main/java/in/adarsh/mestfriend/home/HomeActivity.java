...
import in.adarsh.mestfriend.AbsenceNotification;
import in.adarsh.mestfriend.R;
import in.adarsh.mestfriend.complaint.NoticeActivity;
import in.adarsh.mestfriend.onboarding.LoginActivity;
import in.adarsh.mestfriend.payment.PaymentMenuActivity;
import in.adarsh.mestfriend.vote.VoteActivity;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_payment:
                ...
                startActivity(new Intent(this, PaymentMenuActivity.class));
                break;
